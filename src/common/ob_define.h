...
<<<<<<< HEAD
    ...
    const int OB_ERR_POINTER_IS_NULL = -5204;
    const int OB_ERR_FUNC_DEV = -5205;
    const int OB_ERR_TASK_FULL = -5206;
    const int OB_ERR_HINT_OVERFLOW = -5207;
...
<<<<<<< HEAD
    ...
    //add:e
    //add huangcc [statistic info materialization] 20161208:b
    static const uint64_t OB_ALL_STATISTIC_INFO_TID = 17;
    //add:e
    //add weixing [statistics build v1] 20170401:b
    static const uint64_t OB_UDI_MONITOR_LIST_TID = 18;
    //add e
