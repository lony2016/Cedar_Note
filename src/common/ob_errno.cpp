...
<<<<<<< HEAD
    ...
    ADD_ERROR_STR(OB_ERR_INDEX_NUM_IS_ZERO, "table row is zero!");
    ADD_ERROR_STR(OB_ERR_POINTER_IS_NULL, "pointer is null!");
    ADD_ERROR_STR(OB_ERR_FUNC_DEV, "function error!");
    ADD_ERROR_STR(OB_ERR_TASK_FULL, "task queue is full!");
    ADD_ERROR_STR(OB_ERR_HINT_OVERFLOW, "unmatched item or invalid hint or not support");
