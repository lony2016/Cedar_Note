...
namespace oceanbase
{
  namespace common
  {
    ...
    /**
     * @brief clamp_row_est
     * Force estimate to be at least one row, make it an integer, too.
     * @param nrows
     * @return
     */
    extern double clamp_row_est(double nrows);

    extern bool is_numerical_type(const oceanbase::common::ObObj &value);

    extern double calc_proportion(oceanbase::common::ObExprObj &value,
