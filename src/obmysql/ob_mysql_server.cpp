  ...
  namespace obmysql
  {
    ...
    int ObMySQLServer::get_privilege(ObPrivilege * p_privilege)
    {
      ...
      else
      {
        ...
        context.semi_join_task_queue_ = env_.semi_join_task_queue_;//add wanglei [semi join multi thread] 20170417
    ...
    int ObMySQLServer::do_com_query(ObMySQLCommandPacket* packet)
    {
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        else
        {
          ...
          {
            // do it
            ret = ObSql::direct_execute(q, result, context);//slwang note
                                     ...
                                     )
    {
      ...
      else
      {
        ...
        number = packet->get_packet_header().seq_;
        if (OB_SUCCESS != (ret = result->open()))//slwang note:
        {
