...
* @date 2014_11_23
*/
#ifndef OCEANBASE_SQL_FETCH_STMT_H
#define OCEANBASE_SQL_FETCH_STMT_H
...
namespace oceanbase
{
	...
	{
        /**
        * @brief The ObCursorFetchStmt class
        */
	   class ObCursorFetchStmt : public ObBasicStmt
	   {
		 public:
		 ObCursorFetchStmt()
			: ObBasicStmt(T_CURSOR_FETCH)
		      {
		      }
		 virtual ~ObCursorFetchStmt(){}
         /**
	  ...
	  inline void ObCursorFetchStmt::set_cursor_name(const common::ObString& name)
	  {
	    cursor_name_ = name;
      }
      inline const common::ObString& ObCursorFetchStmt::get_cursor_name() const
	  {
        return cursor_name_;
      }
	}
