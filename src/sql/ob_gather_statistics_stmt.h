...
namespace oceanbase {
    namespace sql {
          ...
          public:
             ...
             common::ObRowkeyInfo& get_row_key_info();
          ...
          private:
             ...
             char tname_[common::OB_MAX_TABLE_NAME_LENGTH];
          };
         ...
         inline int ObGatherStatisticsStmt::set_row_key_info(ResultPlan &result_plan, const common::ObString tname)
         {
         ...
         inline int ObGatherStatisticsStmt::set_statistics_table(ResultPlan &result_plan, const common::ObString tname)
         {
           int ret = common::OB_SUCCESS;
           uint64_t table_id = common::OB_INVALID_ID;
           ObSchemaChecker* schema_checker = NULL;
...
#endif // OB_GATHER_STATISTICS_STMT_H
